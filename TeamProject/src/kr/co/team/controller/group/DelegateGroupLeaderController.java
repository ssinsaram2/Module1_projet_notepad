...
import kr.co.team.service.group.DelegateGroupLeaderService;

public class DelegateGroupLeaderController implements BackController {
	
	IService service = new DelegateGroupLeaderService();
